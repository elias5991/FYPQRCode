...
public interface RoomTypeRequests {
    @GET("http://192.168.0.103:80/php/controllers/room-type-controller.php?f=getAllRoomTypes")
    Call<DataItem[]> getAllRoomTypes();

    @POST("http://192.168.0.103:80/php/controllers/room-type-controller.php?f=insertNewRoomType")
    Call<SuccessResponse> insertNewRoomType(@Body ValueRequest value);

    @PUT("http://192.168.0.103:80/php/controllers/room-type-controller.php?f=updateRoomType")
    Call<SuccessResponse> updateRoomType(@Body DataItem roomTypeDataItem);

    @POST("http://192.168.0.103:80/php/controllers/room-type-controller.php?f=deleteRoomType")
